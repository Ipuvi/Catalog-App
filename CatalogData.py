...
from databasetup import Restaurant, Base, MenuItem, Hotel, Destination, HotelDetails, DestinationDetails, User, Category
...
restaurant1 = Restaurant(user_id=1, name="Urban Burger", category=category1)
